...
namespace RocketCDN\Dependencies\League\Container\ServiceProvider;

use Generator;
use RocketCDN\Dependencies\League\Container\{ContainerAwareInterface, ContainerAwareTrait};
use RocketCDN\Dependencies\League\Container\Exception\ContainerException;
...
class ServiceProviderAggregate implements ServiceProviderAggregateInterface
{
    ...
    public function add($provider) : ServiceProviderAggregateInterface
    {
        ...
        throw new ContainerException(
            ...
            'of (\RocketCDN\Dependencies\League\Container\ServiceProvider\ServiceProviderInterface)'
        );
    }
