...
Tags: bandwidth, cdn, content delivery network, content distribution network, cdn performance, cdn plugin, wordpress cdn plugin
...
[Using a CDN has many benefits](https://rocketcdn.me/benefits-cdn/), one of them is to help your site improve both PageSpeed Insights score and Core Web Vitals grades.

= WHAT ABOUT PAGESPEED INSIGHTS AND THE CORE WEB VITALS? =

If you think that Google loves fast and secure websites, we can indeed confirm that enabling a CDN on your site is also beneficial for SEO and the PageSpeed Insights performance score. In fact, using a Content Delivery Network can boost the [Largest Contentful Paint score](https://wp-rocket.me/google-core-web-vitals-wordpress/improve-largest-contentful-paint/) – one of the Core Web Vitals metrics.

A CDN also helps address two PageSpeed Insights recommendations, such as [Serve static assets with an efficient cache policy](https://wp-rocket.me/google-core-web-vitals-wordpress/serve-static-assets-with-an-efficient-cache-policy/) and Enable text compression.
...
Your website’s loading time significantly affects user experience which is why [reducing server response time](https://wp-rocket.me/google-core-web-vitals-wordpress/reduce-ttfb-server-response-times/) should be a primary goal of website owners and SEO experts.

Lastly, a CDN will deliver HTTP requests faster – another way to [improve the Lighthouse performance score](https://wp-rocket.me/lighthouse-performance-score-wordpress/).
...
== Changelog ==
= 1.0.4 =
- Test the plugin with latest version of WordPress v5.9.3
...
= 1.0.1 =
- Bugfix: Prevent display of wrong API key notice even though the API key is correct
